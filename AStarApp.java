...
public class AStarApp {
    ...
    private void initGUI() {
        ...
        mapCells[startLoc.xCord][startLoc.yCord].setEndpoint(true);
        mapCells[finishLoc.xCord][finishLoc.yCord].setEndpoint(true);
    }
    ...
    private void findAndShowPath() {
        ...
        while (wp != null) {
            ...
            mapCells[loc.xCord][loc.yCord].setPath(true);
